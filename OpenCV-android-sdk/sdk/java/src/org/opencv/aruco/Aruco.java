...
public class Aruco {
    ...
    public static void drawCharucoDiamond(Dictionary dictionary, int[] ids, int squareLength, int markerLength, Mat img, int marginSize, int borderBits) {
        drawCharucoDiamond_0(dictionary.getNativeObjAddr(), ids[0], ids[1], ids[2], ids[3], squareLength, markerLength, img.nativeObj, marginSize, borderBits);
    }
    ...
    public static void drawCharucoDiamond(Dictionary dictionary, int[] ids, int squareLength, int markerLength, Mat img, int marginSize) {
        drawCharucoDiamond_1(dictionary.getNativeObjAddr(), ids[0], ids[1], ids[2], ids[3], squareLength, markerLength, img.nativeObj, marginSize);
    }
    ...
    public static void drawCharucoDiamond(Dictionary dictionary, int[] ids, int squareLength, int markerLength, Mat img) {
        drawCharucoDiamond_2(dictionary.getNativeObjAddr(), ids[0], ids[1], ids[2], ids[3], squareLength, markerLength, img.nativeObj);
    }
    ...
    // C++:  void cv::aruco::drawCharucoDiamond(Ptr_Dictionary dictionary, Vec4i ids, int squareLength, int markerLength, Mat& img, int marginSize = 0, int borderBits = 1)
    private static native void drawCharucoDiamond_0(long dictionary_nativeObj, int ids0, int ids1, int ids2, int ids3, int squareLength, int markerLength, long img_nativeObj, int marginSize, int borderBits);
    private static native void drawCharucoDiamond_1(long dictionary_nativeObj, int ids0, int ids1, int ids2, int ids3, int squareLength, int markerLength, long img_nativeObj, int marginSize);
    private static native void drawCharucoDiamond_2(long dictionary_nativeObj, int ids0, int ids1, int ids2, int ids3, int squareLength, int markerLength, long img_nativeObj);
